    ...
    export class ReceiveRewardsVM extends eui.Component {
        ...
        private changeReward(data: Model.PartInDyModel): string {
            ...
            if (data.type == "MONEY_TYPE_COIN") {
                Model.PlayerLocalService.PlayerData.AddSilver = data.count;//by zhu_jun,2017.03.22.
                if (Model.WebValue.isTraditional) {
                ...
                Model.PlayerLocalService.PlayerData.AddGold = data.count;//by zhu_jun,2017.03.22.
                if (Model.WebValue.isTraditional) {
