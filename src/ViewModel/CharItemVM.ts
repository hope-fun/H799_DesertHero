...
/***************************特效函数***************************/        
        ...
        private playlevelUpAnieml(){
            ...
            //动画完成后隐藏
            this.armature.addEventListener(dragonBones.AnimationEvent.COMPLETE,() => {
                this.armature.display.visible = false;
            },this)
        ...
        private levelUpCharAnimel(id:number=0){
            //光特效
            var light: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.levelUpLight);
            var mcLight: egret.MovieClip = light.initMovieClip("levelUpLight_12_json","levelUpLight_12_png","guangxian",1,() => {
                Main.singleton.mainGameVM.levelUpLight.removeChild(mcLight);
            });
            switch(id){
                case 0:
                    var groud: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.yungeLevelUp);
                    var mc: egret.MovieClip = groud.initMovieClip("levelUp_12_json","levelUp_12_png","dipan",1,()=>{
                    ...
                    break;
                case 1: 
                    var groud: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.baiheLevelUp);
                    var mc: egret.MovieClip = groud.initMovieClip("levelUp_12_json","levelUp_12_png","dipan",1,() => {
                    ...
                    break;
                case 7:
                    var groud: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.bingyiLevelUp);
                    var mc: egret.MovieClip = groud.initMovieClip("levelUp_12_json","levelUp_12_png","dipan",1,() => {
                    ...
                    break;
                case 13:
                    var groud: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.xupingjunLevelUp);
                    var mc: egret.MovieClip = groud.initMovieClip("levelUp_12_json","levelUp_12_png","dipan",1,() => {
                    ...
                    break;
                case 19:
                    var groud: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.mengjueLevelUp);
                    var mc: egret.MovieClip = groud.initMovieClip("levelUp_12_json","levelUp_12_png","dipan",1,() => {
                    ...
                    break;
                case 25:
                    var groud: ViewModel.HeroItemVM = new ViewModel.HeroItemVM(Main.singleton.mainGameVM.liufulingLevelUp);
                    var mc: egret.MovieClip = groud.initMovieClip("levelUp_12_json","levelUp_12_png","dipan",1,() => {
